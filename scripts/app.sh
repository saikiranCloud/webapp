...
sudo pip3 install setuptools-rust bcrypt blinker certifi cffi charset-normalizer click colorama cryptography Flask Flask-Bcrypt Flask-HTTPAuth Flask-SQLAlchemy greenlet idna iniconfig itsdangerous Jinja2 MarkupSafe packaging pluggy pycparser PyJWT PyMySQL pytest python-dotenv regex requests SQLAlchemy typing_extensions urllib3 uuid Werkzeug python-json-logger google-api-core google-auth google-cloud-pubsub googleapis-common-protos grpc-google-iam-v1 grpcio grpcio-status logging proto-plus protobuf pyasn1 pyasn1-modules rsa
